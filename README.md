...
- Pkg folder: [packages\user-identities](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\user-identities)
...
graph LR
  ...
  user_identities["user_identities"]:::center
  user_identities -->|FK| users["users"]:::link
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package user-identities -Apply
