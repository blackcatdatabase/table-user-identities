...
| Pkg folder | [packages\user-identities](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/user-identities) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package user-identities -Apply
