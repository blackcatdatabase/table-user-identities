...
final class Criteria extends BaseCriteria
{
    ...
    {
        return [ 'id', 'user_id', 'provider', 'provider_user_id', 'created_at', 'updated_at' ];
    }
    ...
    {
        $x = [ 'id', 'user_id', 'provider', 'provider_user_id', 'created_at', 'updated_at' ];
    ...
    public static function fromDb(
        ...
        if (\method_exists(\BlackCat\Database\Packages\UserIdentities\Definitions::class, 'softDeleteColumn')) {
            $soft = \BlackCat\Database\Packages\UserIdentities\Definitions::softDeleteColumn();
