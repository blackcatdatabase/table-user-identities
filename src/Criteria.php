 ...
 * - whitelist filtrů: [ 'id', 'user_id', 'provider', 'provider_user_id', 'created_at', 'updated_at' ]
 * - whitelist pro LIKE hledání: [ 'provider', 'provider_user_id' ]
 */
final class Criteria {
    ...
    public function toSql(bool $viewMode = false): array {
        ...
        // filtry (rovnosti / IN)
        $allowed = array_fill_keys([ 'id', 'user_id', 'provider', 'provider_user_id', 'created_at', 'updated_at' ], true);
        ...
        if ($this->search !== null) {
            $searchCols = [ 'provider', 'provider_user_id' ];
            $likeParts = [];
        ...
        $order = null;
        if ($this->sort) {
            $safeCols = array_fill_keys([ 'id', 'user_id', 'provider', 'provider_user_id', 'created_at', 'updated_at' ], true);
            $parts = [];
