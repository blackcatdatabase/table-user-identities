...
namespace BlackCat\Database\Packages\UserIdentities\Mapper;
...
/**
 * Bidirectional mapper between DB rows and DTO UserIdentityDto:
 ...
 */
final class UserIdentityDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'user_id' => 'userId', 'provider' => 'provider', 'provider_user_id' => 'providerUserId', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];
     ...
     */
    public static function fromRow(array $row): UserIdentityDto
    {
        /** @var UserIdentityDto */
    ...
    public static function fromRowOrNull(?array $row): ?UserIdentityDto
    {
     ...
     *
     * @param UserIdentityDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(UserIdentityDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(UserIdentityDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(UserIdentityDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,UserIdentityDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,UserIdentityDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(UserIdentityDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,UserIdentityDto>
     */
