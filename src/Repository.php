...
use BlackCat\Database\Packages\UserIdentities\Repository\UserIdentityRepository as GeneratedRepository;
...
{
  private UserIdentityRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof UserIdentityRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected UserIdentityRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\UserIdentities\Dto\UserIdentityDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\UserIdentities\Dto\UserIdentityDto|null { return $this->repo->getById($id, $asDto); }
