...
final class UserIdentitiesModule implements ModuleInterface
{
    public function name(): string { return 'table-user_identities'; }
    public function table(): string { return 'user_identities'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_user_identities_user', 'ux_provider_user' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_user_identities_user' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_user_identities_user', 'ux_provider_user' ],
            'foreignKeys' => [ 'fk_user_identities_user' ],
        ];
    }
}
